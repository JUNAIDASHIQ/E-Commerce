                                ...
                                <div class="ml-2">
                                    <select name="sort" id="sort" class="form-control">
                                        ...
                                        <option value="price_desc"
                                            {{ request()->get('sort') == 'price_desc' ? 'selected' : '' }}>Price High
                                        </option>
                                        <option value="price_asc"
                                            {{ request()->get('sort') == 'price_asc' ? 'selected' : '' }}>Price Low
                                        </option>
                                    </select>
                                </div>
                            </div>
                                    ...
                                    <div class="card product-card">
                                        <div class="product-image position-relative">
                                            <a href="" class="product-img">
                                                ...
                                                @else
                                                    <span><img src="{{ asset('admin-assets/img/default-150x150') }}"
                                                            class="card-img-top" width="50"></span>
                                                @endif
                                            </a>
...
@section('customJs')
    <script>
        ...
        function apply_filters() {
            ...
            //Sorting Products According ti High Low Price
