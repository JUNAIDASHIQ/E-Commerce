...
<body data-instant-intensity="mousedown">
                                ...
                                <div class="card product-card">
                                    <div class="product-image position-relative">
                                        <a href="" class="product-img">
                                            ...
                                            @else
                                                <span><img src="" class="card-img-top" width="50"></span>
                                            @endif
                                        </a>
                                    ...
                                    <div class="product-image position-relative">
                                        <a href="" class="product-img">
                                            {{-- <img class="card-img-top"
                                                ...
                                                alt=""> --}}
                                                @if ($productImage)
                                                <img src="{{ asset('uploads/product/large/' . $productImage->image) }}" class="card-img-top" width="50">
                                            @else
                                                <span>No Image</span>
                                            @endif
    ...
    <script src="{{ asset('fornt-assets/js/jquery-3.6.0.min.js') }}"></script>
